...
<div class="searchbar" style="overflow: scroll; width: 100%; max-width: 100%;">
    <form method="post">
        <table class="d-flex table table-dark table-striped" style=" text-align: center; overflow: scroll;" >
            <tr>
        ...
        <table class="table table-dark table-striped" style=" text-align: center; overflow: scroll; " >
            <tr>
                <th scope="col">Kategória</th>
                <th scope="col">Edzés leírása</th>
                <th scope="col">Hétfő</th>
